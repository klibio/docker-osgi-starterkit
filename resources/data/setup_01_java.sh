#!/bin/bash
# this script downloads and prepares the java runtime environment
...
QUERY_URL="https://api.adoptopenjdk.net/v2/info/releases/openjdk11?openjdk_impl=hotspot&os=linux&arch=x64&release=latest&type=jre"
